...
func (x *RefreshResponse) GetToken() *TokenPair {
	if x != nil {
		return x.Token
	}
	return nil
...
const file_auth_proto_rawDesc = "" +
	...
	"\x05token\x18\x01 \x01(\v2\x0f.auth.TokenPairR\x05token\"@\n" +
	"\fLoginRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\"6\n" +
	"\rLoginResponse\x12%\n" +
	"\x05token\x18\x01 \x01(\v2\x0f.auth.TokenPairR\x05token\"5\n" +
	"\x0eRefreshRequest\x12#\n" +
	"\rrefresh_token\x18\x01 \x01(\tR\frefreshToken\"8\n" +
	"\x0fRefreshResponse\x12%\n" +
	"\x05token\x18\x01 \x01(\v2\x0f.auth.TokenPairR\x05token\"4\n" +
	"\rLogoutRequest\x12#\n" +
	...
	"\n" +
	"token_type\x18\x04 \x01(\tR\ttokenType2\xec\x01\n" +
	"\vAuthService\x129\n" +
	...
	"\x06Logout\x12\x13.auth.LogoutRequest\x1a\x14.auth.LogoutResponseB/Z-github.com/BohdanKuzmenko1/URLShortener;protob\x06proto3"
...
var file_auth_proto_depIdxs = []int32{
	8, // 0: auth.RegisterResponse.token:type_name -> auth.TokenPair
	8, // 1: auth.LoginResponse.token:type_name -> auth.TokenPair
	8, // 2: auth.RefreshResponse.token:type_name -> auth.TokenPair
	...
	5, // 9: auth.AuthService.RefreshToken:output_type -> auth.RefreshResponse
